...
def test_compressed_prefix_tree_structure_sum() -> None:
    """This is a test for the correct structure of a compressed prefix tree with
    a 'sum' weight type.
...
def test_compressed_prefix_tree_structure_avg() -> None:
    """This is a test for the correct structure of a compressed prefix tree with
    an 'average' weight type.
    ...
    # This tree is using the 'average' aggregate weight option.
    assert t.weight == 3.0
